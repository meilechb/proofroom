...
import { Card, Notice, Meter, PageHeader } from "@/components/ui";
...
export default async function AdminSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Platform settings" description="Global configuration and platform flags." />
      <Card>
        <PlatformSettingsForm settings={settings} />
      </Card>
      <Card>
        <h2 className="text-lg font-medium mb-2">Sending domains</h2>
