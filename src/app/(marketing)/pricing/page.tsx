...
const planRows: Array<Array<React.ReactNode>> = [
  ...
  ["Online store — sell photos, licences & gift cards (0%)", no, yes],
...
const faq = [
  ...
  { q: "Can I sell my photos, not just deliver them?", a: `Yes, on Pro. The online store turns your portfolio and client galleries into a shop: sell single images, packages or a whole-gallery unlock with resolution and licence tiers (including rights-managed), discounts and gift cards. It's paid into your own Stripe at 0% commission, and buyers get a clean, watermark-free download after they pay.` },
