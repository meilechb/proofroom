...
export type LinkKind = "hub" | "unsub" | "invoice" | "receipt" | "preview" | "download";

const DEFAULT_TTL_DAYS: Record<LinkKind, number> = { hub: 7, unsub: 365, invoice: 180, receipt: 3650, preview: 2, download: 3650 };
