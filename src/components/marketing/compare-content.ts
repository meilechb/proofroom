...
export const COMPARE_PAGES: ComparePage[] = [
  {
    ...
    pricing: [
      { label: "Unlimited-storage gallery plan", us: "Pro: $18 per seat a month, unlimited storage", them: "$40 a month (Ultimate)" },
      { label: "Entry paid plan", us: "Free plan: one seat, 3 galleries, 2 GB", them: "$8 a month for 10 GB" },
      { label: "Free tier", us: "Free forever, plus 14 days of Pro to start, no card", them: "3 GB with a 15% commission on sales" },
  ...
  },
  {
    ...
    lastChecked: "September 2026",
    pricing: [
      { label: "Unlimited-storage gallery plan", us: "Pro: $18 per seat a month, unlimited storage", them: "$42 a month" },
      { label: "Entry paid plan", us: "Free plan: one seat, 3 galleries, 2 GB", them: "$7 a month for 20 GB" },
      { label: "Free tier", us: "Free forever, plus 14 days of Pro to start, no card", them: "10 GB, drops to 3 GB after 6 months" },
  ...
  },
  {
    ...
    lastChecked: "September 2026",
    pricing: [
      { label: "Unlimited-storage gallery plan", us: "Pro: $18 per seat a month, unlimited storage", them: "$50 a month" },
      { label: "Entry paid plan", us: "Free plan: one seat, 3 galleries, 2 GB", them: "$10.99 a month" },
      { label: "Free tier", us: "Free forever, plus 14 days of Pro to start, no card", them: "100 photos (3 GB from September 23, 2026)" },
  ...
  },
  {
    ...
    pricing: [
      { label: "Unlimited-storage gallery plan", us: "Pro: $18 per seat a month, unlimited storage", them: "$50 a month" },
      { label: "Entry paid plan", us: "Free plan: one seat, 3 galleries, 2 GB", them: "$7 a month for 15 GB (Lite)" },
      { label: "Free tier", us: "Free forever, plus 14 days of Pro to start, no card", them: "5 GB, 3 galleries, 15% commission" },
  ...
  },
  {
    ...
    lastChecked: "September 2026",
    pricing: [
      { label: "Monthly price", us: "Pro: $18 per seat a month, unlimited storage", them: "$29, $49 or $109 a month on annual billing" },
      ...
      { label: "Free tier", us: "Free forever, plus 14 days of Pro to start, no card", them: "Trial" },
