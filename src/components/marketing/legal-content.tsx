        ...
        <div className="mt-6 card overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="text-ink-2">
              ...
              <tr><td className="px-4 py-3 border-b border-line font-mono text-xs">pr_visitor</td><td className="px-4 py-3 border-b border-line">Remembers the name a client typed when leaving a note in a gallery so they do not have to type it again.</td><td className="px-4 py-3 border-b border-line">90 days</td></tr>
              <tr><td className="px-4 py-3 border-b border-line font-mono text-xs">pr_tenant</td><td className="px-4 py-3 border-b border-line">On preview and development hosts only, remembers which studio site is being viewed so its links resolve.</td><td className="px-4 py-3 border-b border-line">1 hour</td></tr>
              <tr><td className="px-4 py-3 border-b border-line font-mono text-xs">pr_connect_next</td><td className="px-4 py-3 border-b border-line">Holds the return address while a studio connects its Stripe account.</td><td className="px-4 py-3 border-b border-line">Until the connection finishes (at most 1 hour)</td></tr>
              <tr><td className="px-4 py-3 border-b border-line font-mono text-xs">pr_impersonate</td><td className="px-4 py-3 border-b border-line">Set only for platform staff while viewing a studio in read-only support mode; every such view is logged.</td><td className="px-4 py-3 border-b border-line">Until support mode ends</td></tr>
