...
export const FEATURE_PAGES: FeaturePage[] = [
  ...
  },
  {
    ...
    related: ["galleries", "store", "crm"],
  },
  {
    slug: "store",
    nav: "Store",
    title: "Sell your photos, not just deliver them",
    metaTitle: "Sell photos online: digital downloads, licences and gift cards",
    description: "Turn your portfolio and client galleries into a store. Sell single images, packages and whole-gallery unlocks with licences, discounts and gift cards — paid into your own Stripe at 0% commission.",
    eyebrow: "Store",
    lead: "Put a price on the work you already show. Buyers pick a resolution and licence, pay by card on your own Stripe, and get a clean, watermark-free download — no account needed.",
    screenshot: "Shop grid with a product and licence options",
    points: [
      { title: "Sell what you already have", body: "Mark any portfolio image or gallery photo sellable. Sell one image, a package, or a whole gallery as a single unlock." },
      { title: "Resolution and licence tiers", body: "Price web, standard and full-resolution files separately, each with a personal, royalty-free or rights-managed licence and a printable licence document on every order." },
      { title: "Paid into your own Stripe", body: "Direct charges on your connected Stripe account, 0% platform commission — the same posture as the rest of your payments." },
      { title: "Watermark until paid", body: "Previews are watermarked; the clean file is rendered and delivered only after payment, through a signed, expiring download link with a per-order cap." },
      { title: "Discounts and gift cards", body: "Run percent or fixed-amount codes, and issue or sell gift cards buyers redeem at checkout. A cart lets them buy several images at once." },
      { title: "A buyer library, no login", body: "Every purchase opens a tokenised library with downloads, receipts, licences and the buyer's past orders — no password to forget." },
    ],
    steps: [
      { title: "Turn on the store", body: "Set your currency, delivery policy and download limits. The shop appears on your site." },
      { title: "Price your work", body: "Add products or reuse a price sheet across many images. Set licences and any discount codes or gift cards." },
      { title: "Get paid and deliver", body: "Buyers check out on your Stripe; the watermark-free file and a licence are delivered automatically." },
    ],
    faq: [
      { q: "Do you take a cut of sales?", a: "No. Store sales are direct charges on your own Stripe account at 0% commission. Stripe's standard card fee applies and goes to Stripe." },
      { q: "Are my originals safe?", a: "Buyers only ever see watermarked previews. The clean file is served after payment through a signed link that expires and caps downloads; originals are never on a public URL." },
      { q: "Can I sell prints?", a: "The store sells digital files, licences and gift cards today. Lab-fulfilled prints are a planned add-on and are not required to start selling." },
    ],
    related: ["payments", "galleries", "website"],
  },
  {
    slug: "lightroom",
    nav: "Lightroom",
